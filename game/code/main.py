...
def play(playerMode=True):
    ...
    gameState = GameState(GAME_DURATION, allPlayers, background.ennemies, background.objects, TILES_SIZE)
    ...
    while not stop:
        ...
        if gameState.timeLeft <= 0 and not rendered_final_texts:
            ...
            end_of_game_surface = font.render(text, False, (0, 0, 0))
